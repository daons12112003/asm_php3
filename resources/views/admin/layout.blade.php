...
<!-- Mirrored from themesbrand.com/velzon/html/material/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Jul 2023 14:06:49 GMT -->
<head>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="/user"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                        <a class="dropdown-item" href="/index"><i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Trang người dùng</span></a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/category">
                                <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-dashboards">Danh Mục Sản Phẩm</span>
                            </a>
                            
                        </li> <!-- end Dashboard Menu -->
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/phone">
                                <i class="ri-shopping-cart-fill"></i> <span data-key="t-apps">Quản Lý Sản Phẩm</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/banner">
                                <i class="mdi mdi-view-carousel-outline"></i> <span data-key="t-layouts">Quản Lý Bannner</span> <span class="badge badge-pill bg-danger" data-key="t-hot">Hot</span>
                            </a>
                        </li> <!-- end Dashboard Menu -->
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/user" >
                                <i class="mdi mdi-account-circle-outline"></i> <span data-key="t-authentication">Quản lý tài khoản</span>
                            </a>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by Nguyễn Sỹ Đạo
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{asset('images/sidebar/img-1.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>	
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{asset('images/sidebar/img-2.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{asset('images/sidebar/img-3.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{asset('images/sidebar/img-4.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/material/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Jul 2023 14:06:52 GMT -->
</html>